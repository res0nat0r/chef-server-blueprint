...
version          '2.0.0'
issues_url 'https://github.com/RightScale-Services-Cookbooks/chef-server-blueprint/issues' if respond_to?(:issues_url)
source_url 'https://github.com/RightScale-Services-Cookbooks/chef-server-blueprint' if respond_to?(:source_url)
...
attribute 'chef-server-blueprint/backup/lineage',
  ...
  description:     'The prefix that will be used to name/locate the backup of a particular' \
...
attribute 'chef-server-blueprint/backup/storage_account_id',
  ...
  description:     'In order to write the Chef Server backup file to the specified cloud storage location,' \
...
attribute 'chef-server-blueprint/backup/storage_account_endpoint',
  ...
  description:     'The endpoint URL for the storage cloud. This is used to override the' \
